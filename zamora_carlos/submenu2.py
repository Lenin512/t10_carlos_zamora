...
def primer_acontecimiento():
    x=libreria.pedir_primer_acontecimiento("ingrese el primer acontecimiento:")
    print("x")
    contenido= x + "-"
    libreria.guardar_segundo_acontecimiento("info.txt",contenido,"a")
    print("se guardo los datos")

def segundo_acontecimiento():
    y=libreria.pedir_nombre("ingrese el segundo aconecimiento:")
    print("y")
    contenido= y + "-"
    libreria.guardar_datos("info.txt",contenido,"a")
    print("se guardo los datos")

def agregar_acontecimientos():
    print("########### MENU ###########")
    print("#1. Primer acontecimiento: #")
    print("#2. Segundo acontecimiento:#")
    print("#3. Salir.                 #")
    print("############################")
    opc=libreria.pedir_numero("Ingrese Opcion:", 1, 3)
    if (opc==1):
        primer_acontecimiento()
    if(opc==2):
        segundo_acontecimiento()
